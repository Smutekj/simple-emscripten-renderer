...
#define LOW_SAT_RED_LAB float3(61.35, 34.81, 18.38)
#endif
...
#define LOW_SAT_YELLOW_LAB float3(75.50, 5.84, 50.42)
#endif
...
#define LOW_SAT_GREEN_LAB float3(66.82, -25.1, 23.47)
#endif
...
#define LOW_SAT_CYAN_LAB float3(60.53, -22.6, -20.40)
#endif
...
#define LOW_SAT_BLUE_LAB float3(59.66, -2.03, -28.46)
#endif
...
#define LOW_SAT_MAGENTA_LAB float3(59.15, 30.83, -5.72)
#endif
...
#define RED_TINT_10_LAB float3(82.68, 5.03, 3.02)
#endif
...
#define GREEN_TINT_10_LAB float3(82.25, -2.42, 3.78)
#endif
...
#define BLUE_TINT_10_LAB float3(82.29, 2.20, -2.04)
#endif
...
#define RED_TONE_90_LAB float3(24.89, 4.43, 0.78)
#endif
...
#define GREEN_TONE_90_LAB float3(24.89, 4.43, 0.78)
#endif
...
#define BLUE_TONE_90_LAB float3(24.89, 4.43, 0.78)
#endif
...
#define LIGHTEST_SKIN_LAB float3(85.42, 9.41, 14.49)
#endif
...
#define LIGHTER_SKIN_LAB float3(74.28, 9.05, 27.21)
#endif
...
#define MODERATE_SKIN_LAB float3(64.57, 12.39, 37.24)
#endif
...
#define MEDIUM_SKIN_LAB float3(44.49, 17.23, 26.24)
#endif
...
#define DEEP_SKIN_LAB float3(25.29, 7.95, 8.87)
#endif
...
#ifndef GRAY_95_LAB
#define GRAY_95_LAB float3(22.67, 2.11, -1.10)
#endif
...
#ifndef GRAY_05_LAB
#define GRAY_05_LAB float3(90.31, 0.39, 1.09)
#endif
...
#ifndef GRAY_10_LAB
#define GRAY_10_LAB float3(88.85, 1.59, 2.27)
#endif
...
#ifndef GRAY_30_LAB
#define GRAY_30_LAB float3(71.42, 0.99, 1.89)
#endif
...
#ifndef GRAY_50_LAB
#define GRAY_50_LAB float3(55.89, 0.57, 1.19)
#endif
...
#ifndef GRAY_70_LAB
#define GRAY_70_LAB float3(41.57, 0.24, 1.45)
#endif
...
#ifndef GRAY_90_LAB
#define GRAY_90_LAB float3(25.65, 1.24, 0.05)
#endif
...
#define CARD_WHITE_LAB float3(95.99, 0.39, 1.09)
#endif
...
#ifndef GRAY_20_LAB
#define GRAY_20_LAB float3(79.99, 1.17, 2.05)
#endif
...
#ifndef GRAY_40_LAB
#define GRAY_40_LAB float3(65.52, 0.69, 1.86)
#endif
...
#ifndef GRAY_60_LAB
#define GRAY_60_LAB float3(49.62, 0.58, 1.56)
#endif
...
#ifndef GRAY_80_LAB
#define GRAY_80_LAB float3(33.55, 0.35, 1.40)
#endif
...
#define CARD_BLACK_LAB float3(16.91, 1.43, -0.81 )
#endif
...
#define PRIMARY_CYAN_LAB float3(47.12, -32.50, -28.75)
#endif
...
#define PRIMARY_MAGENTA_LAB float3(50.49, 53.45, -13.55)
#endif
...
#define PRIMARY_YELLOW_LAB float3(83.61, 3.36, 87.02)
#endif
...
#define PRIMARY_RED_LAB float3(41.05, 60.75, 31.17)
#endif
...
#define PRIMARY_GREEN_LAB float3(54.14, -40.80, 34.75)
#endif
...
#define PRIMARY_BLUE_LAB float3(24.75, 13.78, -49.48)
#endif
...
#define PRIMARY_ORANGE_LAB float3(60.94, 38.21, 61.31)
#endif
...
#define BLUEPRINT_LAB float3(37.80, 7.30, -43.04)
#endif
...
#ifndef PINK_LAB
#define PINK_LAB float3(49.81, 48.50, 15.76)
#endif
...
#ifndef VIOLET_LAB
#define VIOLET_LAB float3(28.88, 19.36, -24.48)
#endif
...
#define APPLE_GREEN_LAB float3(72.45, -23.60, 60.47)
#endif
...
#define SUNFLOWER_LAB float3(71.65, 23.74, 72.28)
#endif
...
#ifndef AQUA_LAB
#define AQUA_LAB float3(70.19, -31.90, 1.98)
#endif
...
#ifndef LAVANDER_LAB
#define LAVANDER_LAB float3(54.38, 8.84, -25.71)
#endif
...
#define EVERGREEN_LAB float3(42.03, -15.80, 22.93)
#endif
...
#define STEEL_BLUE_LAB float3(48.82, -5.11, -23.08)
#endif
...
#define CLASSIC_LIGHT_SKIN_LAB float3(65.10, 18.14, 18.68)
#endif
...
#define CLASSIC_DARK_SKIN_LAB float3(36.13, 14.15, 15.78)
#endif

#ifndef FNC_PALETTE_SPYDER
#define FNC_PALETTE_SPYDER

float3 spyder (const int index) {
    float3 colors[48];
...
float3 spyderLAB (const int index) {
    float3 colors[48];
...
float3 spyderA (const int index) { return spyder(index);}
float3 spyderB (const int index) { return spyder(index + 24);}
float3 spyderALAB (const int index) { return spyderLAB(index);}
float3 spyderBLAB (const int index) { return spyderLAB(index + 24);}
