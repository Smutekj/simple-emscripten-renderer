...
constexpr const char *fragment_text_code = "#version 300 es\n"
                                           ...
                                           "uniform float u_thickness = 0.51;\n"
                                           "uniform float u_edge_size = 0.10;\n"
                                           "uniform float u_smoothness = 0.75;\n"
                                           "uniform float u_smoothness_inside = 0.05;\n"
                                           "out vec4 FragColor;\n"  
                                           "uniform sampler2D u_texture;\n"
                                           "void main()\n"
                                           "{\n"
                                           "    float glyph = texture(u_texture, v_tex_coord).a;\n"
                                           "    float inside = smoothstep(u_thickness, u_thickness*(1.+u_smoothness_inside), glyph);\n"
                                           "    float inside_and_edge = smoothstep(u_thickness - u_edge_size*(1.+ u_smoothness), u_thickness*(1.+ u_smoothness_inside) - u_edge_size, glyph);\n"
