...
constexpr const char *fragment_text_code = "#version 300 es\n"
                                           ...
                                           "    float inside = smoothstep(thick, thick*(1.+u_smoothness_inside), glyph);\n"
                                           "    float inside_and_edge = smoothstep(thick - u_edge_size*(1.+ u_smoothness), thick*(1.+ u_smoothness_inside) - u_edge_size, glyph);\n"
